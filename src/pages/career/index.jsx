			...
			<li>
				<div className={style.directionL}>
					...
					<div className={style.desc}>
						<b className={style.jobTitle}>Frontend Developer</b>
						...
						<div className={style.leftDesc}>
							<p>
								...
								assets through open marketplace, portfolio management tools, and networking
								solutions.
							</p>
							<span>
			...
			<li>
				<div className={style.directionR}>
					...
					<div className={style.desc}>
						2018.03 - 2020.03
						<br />
						<b className={style.jobTitle}>Frontend Developer (with BFF)</b>
					...
					<div className={style.desc}>
						2015.07 - 2018.02
						<br />
						<b className={style.jobTitle}>Full-Stack Developer</b>
						(JQuery, HTML, CSS, Java, Spring, Jenkins, Oracle, Mybatis)
						<br />
						<br />
						<p>
